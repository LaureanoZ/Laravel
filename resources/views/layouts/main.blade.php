          ...
          <div class="collapse navbar-collapse justify-content-end ww-bg-color py-2 px-2 mt-n1 z-1" id="navbarNav">
            <ul class="navbar-nav align-items-center">
              <li class="nav-item w-100">
                <a class="nav-link text-center w-100 fw-bold ww-focus" aria-current="page" href="{{ route('home') }}">Inicio</a>
              </li>
              <li class="nav-item w-100">
                <a class="nav-link text-center w-100 fw-bold ww-focus" href="{{ route('services.index') }}">Servicios</a>
              </li>
              <li class="nav-item w-100">
                <a class="nav-link text-center w-100 fw-bold ww-focus" href="{{ route('blogs.index') }}">Blog</a>
              </li>
              @auth
              <li class="nav-item">
